...
Scheduler ts;
StatusRequest statusFlashButton;
...
Task taskWifiProcess(100, TASK_FOREVER, &wifiLoop, &ts, true);
Task taskTempHumpProbe(2000, TASK_FOREVER, &tempHumSenseSampleLoop, &ts, true);
